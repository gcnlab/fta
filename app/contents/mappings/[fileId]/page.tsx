...
interface ImportModalState {
  ...
  fileContent: string;
  filters: Array<{ id: number; columnIndex: number; inputValue: string }>; // 旧 value プロパティから inputValue に変更
  fileStats: {
    totalChars: number;
    totalLines: number;
...
export default function MappingPage() {
  ...
  return (
    <div
      className={`container mx-auto p-4 shadow-xl rounded-md border border-gray-300 bg-gray-50 ${
        loading ? 'cursor-wait' : ''
      }`}
    >
      {/* ページの見出し */}
