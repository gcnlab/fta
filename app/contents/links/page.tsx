...
export default function Page() {
  ...
  const SELECTED_TOOL_KEY = 'selectedToolLinks';
  ...
  return (
    <main className="bg-gray-100">
      <div className="mb-2 p-4 bg-white shadow-lg rounded-md border border-gray-300">
        <h1 className="text-base font-semibold text-gray-700 mb-4 text-left">Links</h1>
        ...
        <div className="grid grid-cols-5 gap-2">
          ...
          <MainButton
            label="各種公式"
            isToggle={true}
            isActive={activeToggle === "各種公式"}
            onToggle={() => handleToggle("各種公式")}
          />
