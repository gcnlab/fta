// /app/contents/wizards/ReleaseManual/components/ReleaseManualWizard.tsx
...
export default function ReleaseManualWizard() {
  // 基本情報のステート
  ...
  // ローカルストレージキー
  const LOCAL_STORAGE_KEY = 'selectedToolReleaseManualWizard';
