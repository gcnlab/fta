// /app/contents/wizards/ReleaseManual/components/StepSettingsPanel/common/TextInput2.tsx
...
/**
 * TextInput2 コンポーネントは、ラベル付きのテキスト入力フィールドと、
...
const TextInput2: React.FC<TextInputProps> = ({
  ...
  // 背景色のクラスを条件に応じて設定
  const backgroundClass = isTitleBar ? 'bg-yellow-200' : 'bg-white';
